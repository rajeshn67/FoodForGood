...
const ClaimedDonationsScreen = () => {
  ...
  const fetchDonations = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/api/donations/claimed`, {
        headers: {
          "x-auth-token": token,
        },
      })
  ...
  const renderDonationItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate("ClaimedDonationDetails", { donationId: item._id })}
    >
    ...
    <View style={styles.container}>
      {isLoading ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptySubText}>You haven't claimed any donations yet</Text>
          <TouchableOpacity style={styles.browseButton} onPress={() => navigation.navigate("Available")}>
            <Text style={styles.browseButtonText}>Browse Available Donations</Text>
          </TouchableOpacity>
        </View>
      )}
    </View>
...
export default ClaimedDonationsScreen
