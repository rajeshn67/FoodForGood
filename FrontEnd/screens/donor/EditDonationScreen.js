...
const EditDonationScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${API_URL}/api/donations/${donation._id}`, formData, {
        headers: {
      ...
      Alert.alert("Success", "Your donation has been updated successfully", [
        {
          text: "OK",
          onPress: () => {
      ...
      Alert.alert("Error", error.response?.data?.msg || "Failed to update donation")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <View style={styles.formContainer}>
        ...
        <TouchableOpacity style={styles.submitButton} onPress={handleSubmit} disabled={isLoading}>
          {isLoading ? (
            ...
            <Text style={styles.submitButtonText}>Update Donation</Text>
          )}
        </TouchableOpacity>
      </View>
    </ScrollView>
